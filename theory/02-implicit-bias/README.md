...
|---|---|---|
| Soudry et al. 2018 | $w(t)=\hat w\log t+\tilde w$, angle $=O(1/\log t)$ | 2D: residual matches the SVM-dual $\tilde w$ to ~1e-7 at $t=10^{100}$; d=50: angle·ln t flattens |
...
| **new**: Muon / spectral descent | spectral-norm max margin | see post §6 |
